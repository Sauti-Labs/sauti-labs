...
Data governance principles and rules - e.g. the restriction/redistribution/investigation rules established for the Dholuo Resource Census.

## Boundary

Individual source rights tracking belongs in data/provenance/ and data/licensing/.
