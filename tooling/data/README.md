...
Data acquisition and processing tooling - the eventual home of scripts like fetch-storybook-corpus.js.

## Boundary

This currently holds no content - existing scripts/ is untouched in this step.
